 ...
 */
else/* (!(board.getAuthor()).equals(mname)) */{ 
...
<form action="boardedit.jsp" method="post" enctype="multipart/form-data">"
   ...
   <div class ="col-sm-10">
      <input name = "title" value = "<%=board.getTitle() %>" type="text" class="form-control" placeholder ="제목을 입력하세요">
   </div>
   </div>
  ...
  <textarea class="summernote" name="content" ><%=board.getContent() %></textarea>    
